...
待评价
 */
public class Commit_Adapter extends RecyclerView.Adapter<Commit_Adapter.ViewHolder> {
    private final FragmentActivity context;
    private List<Null_Bean> list;
    private Null_Pay_Item_Adapter null_pay_item_adapter;
    public Commit_Adapter(FragmentActivity activity) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = View.inflate(context, R.layout.commit_item, null);
