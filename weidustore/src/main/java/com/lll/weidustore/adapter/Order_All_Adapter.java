...
public class Order_All_Adapter extends RecyclerView.Adapter<Order_All_Adapter.ViewHolder> {
    private final FragmentActivity context;
    private List<Null_Bean> list = new ArrayList<>();
    private Null_Pay_Item_Adapter null_pay_item_adapter;
    public Order_All_Adapter(FragmentActivity activity) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = View.inflate(context, R.layout.order_all_item, null);
